...
public class ReadabilityGuidelinesDemo {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("process(45)       -> " + NamingUnclear.process(45) + "  (process what? 45 what?)");
        System.out.println("hasExpired(45)     -> " + NamingClear.hasExpired(45) + "  (an overdue-by-45-days payment)");
        ...
        double before = MethodSizeMonolithic.checkoutTotalMonolithic(prices, 0.08, 0.10);
        double after = MethodSizeExtracted.checkoutTotal(prices, 0.08, 0.10);
        ...
        System.out.println("isClearedMagicNumber(1) -> " + MagicNumberBefore.isClearedMagicNumber(1) + "  (is 1 CLEARED? PENDING? you have to check)");
        System.out.println("isCleared(CLEARED)      -> " + StatusEnumAfter.isCleared(StatusEnumAfter.Status.CLEARED) + "  (the name is the documentation)");
